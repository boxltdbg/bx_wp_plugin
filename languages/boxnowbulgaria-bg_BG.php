...
return [
  ...
  'Allow multiple labels per order' => 'Разрешаване на множество етикети за поръчка',
  'Enable (prepaid orders only)' => 'Включено (само за предплатени поръчки)',
  'When enabled, merchants can generate multiple shipping labels from a single order. This applies to prepaid orders only. COD orders always generate a single label to prevent duplicate payment requests.' => 'При включване, търговците могат да генерират множество товарителници от една поръчка. Това се прилага само за предплатени поръчки. При поръчки с наложен платеж винаги се генерира само 1 товарителница, за да се предотвратят дублирани заявки за плащане.',
